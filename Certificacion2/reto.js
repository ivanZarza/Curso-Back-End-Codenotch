...
console.log('Reto 1'.bgWhite.black);
...
// Reto 2
console.log('Reto 2'.bgWhite.black);
let raizCuadrada = Math.sqrt(1369);
console.log(raizCuadrada);

// Reto 3
console.log('Reto 3'.bgWhite.black);
let numAleatorio = Math.round(Math.random() * (0,  10))
console.log(numAleatorio);

// Reto 4
console.log('Reto 4'.bgWhite.black);
let nombre = 'Nico';
let apellido = 'Zarza';
...
// Reto 5
console.log('Reto 5'.bgWhite.black);
